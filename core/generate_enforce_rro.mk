...
enforce_rro_product_name := $(subst lineage_,lightning_,$(PRODUCT_NAME))
enforce_rro_override_module := $(subst Lineage,Lightning,$(subst lineage,lightning,$(subst lineageos,lightning,$(enforce_rro_source_module))))
